...
/**
 * this calculator is also not used
 */
import java.util.ArrayList;

public class SDCalculator2b implements ICalculator<ArrayList<Double>> {
	 ...
	 */
	public void addone(double value) {
		_sumXX += value * value;
		_sumX += value;
		_count++;
		// TODO LOGIC xQMHZj
	 ...
	 */
	public void removeone(double value) {
		if (_count < 1)
	...
	@Override
	public ArrayList getlag(int lag) {
		ArrayList<Double> sumSDarr = new ArrayList<Double>();
		sumSDarr.add(this.getMean());
		sumSDarr.add(this.getSampleSD());
		// TODO Auto-generated method stub
		return sumSDarr;
	}
